...
import { useDropdown, useDisplayForm, useDisplayGame } from '../context/context';
...
export default function DropdownMenu() {
  ...
  return (
    <div className='relative w-1/2 m-auto content-center'>
      <Dropdown onChange={(e) => setDropDownChoice(e.value)} className='rotate-3 m-auto my-3 z-10' placeholder={DropDownOptions.Rule} options={[DropDownOptions.Rule, DropDownOptions.Dilemma, DropDownOptions.Trivia, DropDownOptions.Pointing, DropDownOptions.Mix]} />
