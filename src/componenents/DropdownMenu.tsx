...
import { useDropdown, useDisplayForm, useDisplayGame, useSetGameMode } from '../context/context';
...
export const DropDownPicker = (): JSX.Element => {
  ...
  switch(gameMode) {
    ...
    default:
      return <Dropdown onChange={(e) => setGameMode(e.value)} className='rotate-3 m-auto my-3 z-10'
